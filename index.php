...
<body>
    ...
    </nav <!-- <a href="index.html" id="logo">16-bits</a>
    <nav id="nav">
        ...
        <ul id="menu">
            ...
            <li><a href="https://zithalo.github.io/html-css-gg/challenges/modulo3/cordel.html" target="_blank"
                    rel="external"> Cordel</a></li> -->
